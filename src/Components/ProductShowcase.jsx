...
const ProductShowcase = () => {
  ...
  return (
    <>
      <section className="bg-linear-to-br from-[#F8F4E1] to-[#AF8F6F] py-20 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-[#543310] mb-4">
          ...
          >
            {exclusive.map((product) => (
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-[#543310] mb-2 playfair-heading">
                    {product.name}
                  </h3>
                  <p className="text-[#74512D] text-xl font-bold mb-4 poppins-body">
                    {product.price}
                  </p>
                  <div className="flex gap-3">
                    <button
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="p-8">
                ...
                <p className="text-2xl font-bold text-[#74512D] mb-6 poppins-body">
                ...
                <div className="space-y-6">
                  {/* Description */}
                  <div>
                    <h3 className="text-lg font-semibold text-[#543310] mb-2 playfair-heading">
                      Description
                    </h3>
                    <p className="text-[#74512D] leading-relaxed poppins-body">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-sm font-semibold text-[#543310] playfair-heading">
                        Weight
                      </h4>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xl font-bold text-[#543310] w-8 text-center poppins-body">
                        {quantity}
                      </span>
                      <button
                        onClick={() => handleQuantityChange(1)}
