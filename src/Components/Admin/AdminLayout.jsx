  ...
  if (!user || user.role !== "admin") {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F8F4E1]">
        <div className="text-center p-8 bg-white rounded-xl shadow-lg border border-[#F8F4E1]">
  ...
  return (
    <div className="flex h-screen bg-[#F8F4E1]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="sticky top-0 z-10 bg-white/90 backdrop-blur-sm border-b border-[#AF8F6F]/20 shadow-sm">
          <div className="flex justify-between items-center px-6 py-4">
            <div>
              <h1 className="text-xl font-bold text-[#543310]">
                Dashboard Overview
              </h1>
              <p className="text-[#74512D] opacity-80 text-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* User Avatar */}
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#AF8F6F] to-[#74512D] flex items-center justify-center shadow">
        ...
        {/* Footer */}
        <footer className="px-6 py-3 border-t border-[#AF8F6F]/20 bg-white/50">
          <div className="flex justify-between items-center text-[#74512D] text-xs">
