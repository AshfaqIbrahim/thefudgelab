            ...
            >
              <div className="p-4">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[#F8F4E1]">
                  <button
                    onClick={() => handleViewDetails(user)}
                    className="flex-1 mr-2 px-3 py-2 bg-[#F8F4E1] hover:bg-[#AF8F6F] text-[#543310] rounded-lg transition-colors flex items-center justify-center space-x-2"
                  >
                  ...
                  <button
                    onClick={() => handleDeleteUser(user.id)}
                    className="flex-1 ml-2 px-3 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 rounded-lg transition-colors flex items-center justify-center space-x-2"
                  >
