            ...
            >
              <div className="p-4">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-start space-x-3 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-[#543310] truncate">
                        {product.name}
                      </h3>
                      <p className="text-[#74512D] text-sm truncate">
                        {product.category || "Brownies"}
                      </p>
                      <p className="font-bold text-[#543310] text-lg mt-1">
                        {product.price}
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-[#F8F4E1]">
                  <button
                    onClick={() => handleEditClick(product)}
                    className="flex-1 mr-2 px-3 py-2 bg-[#F8F4E1] hover:bg-[#AF8F6F] text-[#543310] rounded-lg transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={isSubmitting}
                  >
                  ...
                  <button
                    onClick={() => handleDeleteProduct(product.id)}
                    className="flex-1 ml-2 px-3 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 rounded-lg transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={isSubmitting}
                  >
